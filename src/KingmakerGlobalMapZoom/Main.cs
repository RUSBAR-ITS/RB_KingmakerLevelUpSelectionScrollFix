...
namespace KingmakerGlobalMapZoom
{
    ...
    {
        internal const string ModId = "KingmakerGlobalMapZoom";
        ...
        private static void OnSaveGUI(UnityModManager.ModEntry modEntry)
        {
            if (Settings != null)
            {
                ...
                GlobalMapZoomController.ResetDiagnostics();

                if (Settings.ApplyOnSettingsSave)
                {
                    GlobalMapZoomController.ApplyNow("settings saved");
                }
